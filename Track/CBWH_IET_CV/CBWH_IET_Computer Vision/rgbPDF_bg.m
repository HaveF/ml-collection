...
% *****************************************************************
% function: calculate background model
% parameters:
%       image               current frame
%       center              initial position of the target
%       w_halfsize          half size of the target window         
%       w_halfsize_bg       half size of the background window
% return:
%       o_u          ¡¡     background model
%       v_u                 transformed background model
%
% Jifeng Ning, College of Information Engineering, Northwest A&F
% Univerisity, jf_ning@sina.com
% July 7,2010
% ****************************************************************
