function [hiso,FV]=plot3t(varargin)
% PLOT3T Plots a (cylindrical) 3D line with a certain thickness.
%
%   [h,FV] = plot3t(x,y,z,r,'color',n);
%
...
%   
%   (optional)
%   FV : The Patch / Mesh which makes up the line
%
%   Example:
...
function [a,b]=getab(normal)
    ...
    % the normal vector.
    randomv=[0 0.09950371902099892900 0.99503719020998926000]; 
