...
%
%   Function is written by D.Kroon University of Twente (Updated Jun. 2011)
...
while(true)
    ...
    % Set exit flag if new objective-value is higher then previous value
    if(isfield(data,'f_alpha')&&data.fOld<=data.f_alpha)
        data.exitflag=4;
    end
